      ...
      <div className="flex-1 flex bg-white/95 backdrop-blur-sm">
        ...
        <div className="w-[40%] bg-[#1b2531] text-white p-3 flex flex-col gap-2 shadow-[inset_10px_0_20px_-10px_rgba(0,0,0,0.5)] border-l border-[#536577]">
             ...
             <div className="flex items-center gap-3 mb-2 cursor-pointer hover:bg-white/10 p-2 rounded transition-colors group">
                ...
                <div className="flex flex-col">
                    <span className="font-bold text-sm text-white group-hover:text-[#dceafc]">Mr. Robot</span>
             ...
             <span className="text-sm hover:text-white hover:bg-white/10 p-1 rounded text-[#cfd8e6] cursor-pointer transition-colors font-medium">Programas Padrão</span>
...
export const Taskbar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 w-full h-10 flex items-center justify-between z-[9999] px-1 select-none backdrop-blur-md transition-all duration-300"
           style={taskbarStyle}
      >
          ...
          {windows.map((win) => (
             <button
               ...
               className={clsx(
                 ...
                 activeWindowId === win.id && !win.isMinimized ? itemStyle(true) : ""
               )}
             >
